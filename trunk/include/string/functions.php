<?php
	...
	namespace hiweb\string;


	function explode_by_symbol( $string ){ return preg_split( '//u', $string, - 1, PREG_SPLIT_NO_EMPTY ); }

	function rand( $return_col = 20, $in_use_latin = true, $in_use_number = true, $useReg = false ){
		$symb_arr = [];
		$symb_only_latin_arr = [];
		if( $in_use_latin ){
