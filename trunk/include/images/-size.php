<?php
	...
	class size extends path{
		 ...
		 * @param int    $height
		 */
		public function __construct( $path = false, image $image, $size_name = '', $width = 0, $height = 0 ){
		...
		//			$this->data = $data instanceof arrays\array_ ? $data : arrays::get( $data );
		...
		public function _make( $quality_jpg_png = 75, $replace = true ){
			if( !$this->get_image() instanceof image )
				return - 1;
			///
