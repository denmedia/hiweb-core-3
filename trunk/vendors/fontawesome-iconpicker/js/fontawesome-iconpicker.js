...
(function (a) {
    ...
    c.defaultOptions = {
        ...
        templates: {
            ...
            buttons: '<button class="iconpicker-btn iconpicker-btn-cancel btn btn-default btn-sm">Отмена</button>' + ' <button class="iconpicker-btn iconpicker-btn-accept btn btn-primary btn-sm">Применить</button>',
    ...
    if (typeof ___FONT_AWESOME___ === 'object' && ___FONT_AWESOME___.hasOwnProperty('styles')) {
        for (var prefix in ___FONT_AWESOME___.styles) {
            ...
            for (var index in sub_icons) {
                c.defaultOptions.icons.push(prefix + ' fa-' + index);
            }
        }
    } else {
        console.info('hiweb-field-fontawesome: Use Default Icons Pack...');
